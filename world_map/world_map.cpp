...
WorldMap::WorldMap(const TileMatrix& map) :
    _map(map) {}
...
CellVector WorldMap::getShortestWay(Cell from, Cell to) const
{
...
CellVector WorldMap::_getAdjacentCells(int x, int y) const
/*
...
double WorldMap::_calculateHeuristic(Cell from, Cell to) const
{
